                                                        ...
                                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                ...
                                                                <td>
                                                                    <div class="contentEditableContainer contentTextEditable">
                                                                        <div class="contentEditable">
                                                                            <h2 align="center">Contact Request Form Notification</h2>
                                                                            <br>
                                                                            <p style="font-size: 14px;font-family: 'Harmattan', sans-serif;text-align:justify;">
                                                                                ...
                                                                                Subject: {{ $contact->email_subject }}<br>
                                                                                Message: {{ $contact->email_messagemessage }}<br>
                                                                            </p>
                                                                        </div>
                                                                    </div>
                                                                </td>
                                                            ...
                                                            <tr>
                                                                <td class="esd-block-text es-p20t" align="center">
                                                                    <h3 style="color: #333333;">Thank you, Aogo Microfinance Bank Limited</h3>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    </td>
                                                                        ...
                                                                        <tbody>
                                                                            <tr>
                                                                                <td class="esd-block-text es-m-txt-c es-p5b" esdev-links-color="#777777" align="left">
                                                                                    <p style="color: #777777;"> © 2023
                                                                                        Aogo Microfinance Bank Limited <br> You are receiving
                                                                                        this email because you signed up
                                                                                        on <a href="aogomfbltd.com" style="color:#aaaaaa">Aogo Microfinance Bank Limited</a>. .<br></p>
                                                                                </td>
                                                                            </tr>
                                                                        </tbody>
                                                                    </table>
